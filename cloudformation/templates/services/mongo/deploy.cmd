...
aws s3 cp .\mongodb_accounts.yaml s3://aws-cloud-formation-repo-engineering  --region eu-west-2 --profile i2n-engineering
aws s3 cp .\mongodb_single_node.yaml s3://aws-cloud-formation-repo-engineering  --region eu-west-2 --profile i2n-engineering
